...
\begin{figure}
    \includegraphics[width=\textwidth]{flatland-model-of-a-lock}
    \caption{Flatland model of a lock}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{flatland-key-raises-pins}
    \caption{(a) Flatland key raises pins}
\end{figure}

\begin{figure}
    \includegraphics[width=\textwidth]{proper-key-allows-plates-to-slide}
